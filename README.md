...
<img src="assets/banner.svg" alt="Alejandro Castor, Analista de Dados e BI. Do dado bruto à decisão." width="100%">

<br>

<a href="https://claude.ai/artifact/WoGMnjhwSAoJuStGMEWP81"><img src="assets/btn-portfolio.svg" alt="Ver o portfólio" height="46"></a>&nbsp;
<a href="https://www.linkedin.com/in/alejandrocastor-6a4311254"><img src="assets/btn-linkedin.svg" alt="LinkedIn" height="46"></a>&nbsp;
<a href="mailto:alejandrocastorfadim@gmail.com"><img src="assets/btn-email.svg" alt="E-mail" height="46"></a>
...
<img src="assets/pipeline.svg" alt="Fluxo em cinco etapas: fontes, ingestão, camadas, modelo e decisão, com validação e conciliação em cada etapa." width="100%">

<br>

## Stack

<img src="assets/stack.svg" alt="Dados e engenharia: SQL Server, PostgreSQL, Python, PySpark, Databricks, ETL e ELT, APIs REST, Parquet. BI e modelagem: Power BI, DAX, Power Query, modelagem dimensional, star schema, KPIs e OKRs, dashboards HTML. Práticas: Git e GitHub, conciliação de dados, governança de dados, comunicação com o negócio, IA generativa aplicada." width="100%">
...
<a href="https://claude.ai/artifact/WoGMnjhwSAoJuStGMEWP81"><img src="assets/loja-perfeita.png" alt="Painel Loja Perfeita em Power BI: visão executiva com nota geral, cinco pilares, metas e ranking de lojas."></a>
</td>
<td valign="top">
...
<img src="assets/rodape.svg" alt="Confiança no número vem antes do gráfico bonito." width="100%">
